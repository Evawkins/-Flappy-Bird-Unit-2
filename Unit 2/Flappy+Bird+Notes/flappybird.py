...
upper_pipe_image = pygame.image.load('/Users/evawilkins/Desktop/CS101/Units/Unit 2/Flappy+Bird+Notes/Flappy Bird Game Obstacles/pipe.png')  # Make sure to have an image named 'pipe.png' in the same folder
...
lower_pipe_image = pygame.image.load('/Users/evawilkins/Desktop/CS101/Units/Unit 2/Flappy+Bird+Notes/Flappy Bird Game Obstacles/pipe.png')

# Load background image
bg_image = pygame.image.load('/Users/evawilkins/Desktop/CS101/Units/Unit 2/Flappy+Bird+Notes/Flappy Bird Basics/bg.png')
...
# this is the position of our bird image
bird_x = 50
bird_y = 50
bird_velocity = 0
flap_power = -11 
